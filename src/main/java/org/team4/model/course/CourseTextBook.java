...
public class CourseTextBook extends Book {
    ...
    public CourseTextBook(Item item, String genre, int noOfPages, String author, String ISBN, String publisherName, String edition, Course course, boolean isVirtual) {
